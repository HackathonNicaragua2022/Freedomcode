...
export default function Alchol(props) {
  return (
    <View>
      <View style={styles.container}>
        <TouchableOpacity
          style={styles.arrow}
          onPress={() => props.navigation.navigate("Hypertension")}
        >
      ...
      <View style={styles.boxElements}>
        <View style={styles.boxText}>
          <Textexams title={"¿Consume alchol?"} />
        </View>

        <Btnexams
          titleButton={"SI"}
          Pressable={() => props.navigation.navigate("Tobacco")}
        />
        <Btnexams
          titleButton={"NO"}
          Pressable={() => props.navigation.navigate("Tobacco")}
