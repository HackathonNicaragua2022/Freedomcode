...
export default function Obesity(props) {
  return (
    <View>
      <View style={styles.container}>
        <TouchableOpacity
          style={styles.arrow}
          onPress={() => props.navigation.navigate("Sexuality")}
        >
      ...
      <View style={styles.boxElements}>
        <View style={styles.boxText}>
          <Textexams title={"¿Padece de obesidad?"} />
        </View>
        <Btnexams
          titleButton={"SI"}
          Pressable={() => props.navigation.navigate("Hypertension")}
        />
        <Btnexams
          titleButton={"NO"}
          Pressable={() => props.navigation.navigate("Hypertension")}
