...
export default function ResultExamSelect(props) {
  return (
    <View>
      <View style={styles.container}>
        <TouchableOpacity
          style={styles.arrow}
          onPress={() => props.navigation.navigate("Cruentos")}
        >
      ...
      <View style={styles.boxElements}>
        ...
        <Btnexams
          titleButton={"EXPLORACION"}
          Pressable={() => props.navigation.navigate("Afected")}
        />
