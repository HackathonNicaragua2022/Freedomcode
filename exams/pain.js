...
export default function Pain(props) {
  return (
    <View>
      <View style={styles.container}>
        <TouchableOpacity
          style={styles.arrow}
          onPress={() => props.navigation.navigate("Atrophy")}
        >
      ...
      <View style={styles.boxElements}>
        <View style={styles.boxText}>
          <Textexams title={"SENSIBILIDAD DEL DOLOR"} />
        </View>
        <Btnexams
          titleButton={"AUSENTE"}
          Pressable={() => props.navigation.navigate("Deformation")}
        />
        <Btnexams
          titleButton={"BAJA"}
          Pressable={() => props.navigation.navigate("Deformation")}
